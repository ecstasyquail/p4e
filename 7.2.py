...
number on the line. Count these lines and then compute the total of the spam confidence values from these lines. When
...
for line in fhand:
    if "X-DSPAM-Confidence:" in line:
        ...
        count += 1
        numlist.append(num)
print("Average Spam Confidence:", sum(numlist) / count)
